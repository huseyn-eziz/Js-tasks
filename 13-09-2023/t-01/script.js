...
// const netice = array.filter((elem)=> parseInt(elem.address.zipcode) <= 50000)


//! Task2. Get all users whose email ends with '.net'.

// const netice = array.filter((elem)=> elem.email.endsWith(".net") )

//! Task3. Get an array of objects containing only the name and email of users whose name starts with 'C'.

// const net = array.filter((elem)=> elem.name.startsWith("C") )

// const netice = net.map((elem)=> ({ name : elem.name ,  email: elem.email}) )

//! Task4. Get an array of all user names in uppercase.

// const netice = array.filter((elem)=> elem.name.toUpperCase() )

//! Task5. Get the total number of users in the array.

// const netice = array.length

//! Task6. Get the sum of all user IDs.
// const netice = array.map((id)=> id.id).reduce((a,b)=> a+b) 

//! Task7. Get the user with the highest ID.

// const netice = array.sort((a,b)=> b.id-a.id)[0]

//! Task8. Get an array of all user names sorted in alphabetical order.
//!usul1
// const netice = array.sort((a,b)=> a.name.charCodeAt(0) - b.name.charCodeAt(0))
//!usul2

// const netice = array.map(user => user.name).sort()


//! Task9. Get an array of users whose name starts with the letter 'P'.

// const netice = array.filter(user => user.name.startsWith('P'))

//! Task10. Get an array of users whose email contains the string 'org'.

// const netice = array.filter(user => user.email.includes('org'));

//!   Task11. Get an array of users whose phone number starts with the area code '1-770'.

// const netice = array.filter((elem)=> elem.phone.startsWith("1-770") )

//! Task12. Get an array of all user addresses as strings.


// const netice = array.map(user => `${user.address.street}, ${user.address.suite}, ${user.address.city}, ${user.address.zipcode}`)


//! Task13. Get an array of all user cities.

// const netice = array.map(user => user.address.city)
